 ...
 */
final class Version20220211201904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reunion ADD date_reunion DATETIME NOT NULL, DROP date');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reunion ADD date VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP date_reunion, CHANGE objet objet VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
